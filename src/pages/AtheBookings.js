...
const AtheBookings = () => {
  ...
  const bookingDataHandler = async () => {
    ...
    if (date) {
      ...
      var appointments = await GetRecentBookingsSearch(dispatch, { currentPage: 1, searchQuery: userEmail, selectedDate: date, selectedServiceTypes: value })
    }
    else {

      var appointments = await GetRecentBookingsSearch(dispatch, { currentPage: 1, searchQuery: userEmail, selectedServiceTypes: value })
    }
  ...
  const elements = [
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Carbon', time: <p className='time'>9:23 AM</p>, button: <button className='pending'>Pending</button>, status: <NavLink to="/a-prescription"><button className="fill">View Presription</button></NavLink> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Nitrogen', time: <p className='time'>9:23 AM</p>, button: <button className='fail'>Failed</button>, status: <button className="empty">NA</button> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Yttrium', time: <p className='time'>9:23 AM</p>, button: <button className='success'>Success</button>, status: <NavLink to="/a-prescription"><button className="fill">View Presription</button></NavLink> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Barium', time: <p className='time'>9:23 AM</p>, button: <button className='pending'>Pending</button>, status: <button className="empty">NA</button> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Cerium', time: <p className='time'>9:23 AM</p>, button: <button className='success'>Success</button>, status: <button className="empty">NA</button> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Cerium', time: <p className='time'>9:23 AM</p>, button: <button className='fail'>Failed</button>, status: <NavLink to="/a-prescription"><button className="fill">View Presription</button></NavLink> },
    { Name: <div className='name-cont'><Avatar src={url} /><div><h6>Mr. Scott Mctominay</h6> <p>curtis.weaver@example.com</p></div></div>, mass: "Sports Vision Performance", symbol: 'Oct 17, 2023', name: 'Cerium', time: <p className='time'>9:23 AM</p>, button: <button className='success'>Success</button>, status: <button className="empty">NA</button> },
  ];
  ...
  return (
    ...
    <AtheleteMenu className="datepicker">
      <Modal.Root opened={paymentmodal} onClose={() => {
        ...
        <Modal.Overlay />
        <Modal.Content>
          <PaymentForm clientSecret={clientSecret} mainheading={mainheading} subheading={subheading} body={body} />
        </Modal.Content>
      </Modal.Root>
      ...
      <div className='transaction-table-cont'>
        <div className="transaction-table">
          <div className="transaction-table-console">
            ...
            <div className="d-flex console-inputs">
              <Select
                ...
                data={['Medical/OfficeVisit', 'ConsultationCall', 'AddTrainingSessions', 'Post-ConcussionEvaluation', 'SportsVisionPerformanceEvaluation']}
          ...
          {isFetching ? <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "15px", padding: "30px" }}><Skeleton height={80} /> <Skeleton height={80} /> <Skeleton height={80} /></div> :
            <>
              {
                showData.length == 0 ? <div style={{ width: "100%", padding: "30px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                  <h1 style={{ color: "#3C3F53CC" }}>
                    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", justfiyContent: "center", flexDirection: "column" }}>

                      <img src="/images/DoctorMenuLogo.png" style={{ height: "250px", marginBottom: "-40px" }} />
                      <h3>No Recent Booking Found</h3>
                    </div>
                  </h1>
                </div> : <div className="mt-3 table-cont">
                  <Table>
                    <Table.Thead>
