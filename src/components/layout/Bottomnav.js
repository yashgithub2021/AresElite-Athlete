...
console.log(bottomNavItems)
  ...
  return (
    <>
    {showHeader && <div className={`sticky-header ${showHeader ? 'show' : ''}`}>
    <p style={{color:"white"}}><span style={{marginRight:"4px"}}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
