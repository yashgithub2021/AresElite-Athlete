...
const navigate=useNavigate()
 const [opened, { open, close }] = useDisclosure(false)
  return (
    ...
    <Drawer.Root opened={opened} onClose={close} style={{width:"20vw"}}  overlayProps={{ backgroundOpacity: 0.5, blur: 4 }} size="xs" >
    <Drawer.Overlay />
    <Drawer.Content >
...
<NavLink to="/"><div className={match=="/" ? 'sidenav-button bg-white-btn':'sidenav-button'}>
  <p>
...
<NavLink to="/a-transactions"><div className={match=="/a-transactions" ? 'sidenav-button bg-white-btn ':'sidenav-button'}>
  <p>
...
<NavLink to="/a-booking"><div className={match=="/a-booking" ? 'sidenav-button bg-white-btn':'sidenav-button'}>
  <p>
    <span style={{ marginRight: "20px" }}>
      <svg
        width="24"
...
<NavLink to="/a-manager"><div className={match=="/a-manager" ? 'sidenav-button bg-white-btn':'sidenav-button'}>
  <p>
    <span style={{ marginRight: "20px" }}>
      <svg
        width="24"
...
<path d="M17 8L15.6 9.4L17.2 11H9V13H17.2L15.6 14.6L17 16L21 12L17 8ZM5 5H12V3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H12V19H5V5Z" fill="white"/>
      ...
      <i class="fa-solid fa-bars" style={{fontSize:"20px"}} onClick={open}></i>
    </div>
